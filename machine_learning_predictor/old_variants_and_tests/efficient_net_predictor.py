...
import numpy as np
from machine_learning_predictor.old_variants_and_tests.transfer_learning_classifier import DifficultyImageClassifier
...
if use_gen_v2:
    from machine_learning_predictor.old_variants_and_tests.custom_data_generator_v2 import CustomImageDataGenerator
else:
    from machine_learning_predictor.old_variants_and_tests.custom_data_generator import CustomImageDataGenerator
